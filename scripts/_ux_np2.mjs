...
await page.locator('.deploy-btn').click(); await page.waitForSelector('canvas'); await page.waitForTimeout(4500);
await page.locator('.actionbar .actions button',{hasText:/AI:/}).click(); await page.waitForTimeout(400);
await page.getByRole('button',{name:'Next Phase ▸'}).click(); await page.waitForTimeout(800);
console.log('->',await phase());
await page.mouse.click(455,490); await page.waitForTimeout(500);
await page.getByRole('button',{name:'Next Phase ▸'}).click(); await page.waitForTimeout(800);
console.log('with selection, targeted Next Phase ->',await phase());
await b.close();
