...
export interface TechNode {
   ...
   * the neighbour. Carnage's channel is rows 0-3: rows 0-2 are the old spine
   * and row 3 is the harvest ladder (Clean Kills, the Bone Levy). The two
   * nodes that were squatting on row 3 (`plate_lines`, `grand_forge`) moved
   * into their own creeds' channels, where they should have been.
   */
  row: number
