...
export const TECH_MECHANICS: Record<TechId, string> = {
  ...
  salting: 'Everything lying on your half keeps 70% longer. Base life off a cheap body: meat 12s, skull 18s, bone 26s — and a body worth five times as much lies there roughly four times as long.',
  deep_cold: 'A further 60% on top of Salting (2.7x base together). An elite carcass now outlasts a gatherer’s round trip from the far side of your half.',
